...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	  HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_13); // Change GPIOC and PIN_13 as needed
...
void MX_GPIO_Init(void)
{
    ...
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW; // Set low frequency
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct); // Initialize GPIOC with the settings
}
void SystemClock_Config(void)
{
